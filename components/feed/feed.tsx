...
export default function Feed({ tweets: tweetsProp, title }: Props) {
   ...
   return (
      <div className="hide-scrollbar col-span-10 sm:col-span-8 h-screen overflow-scroll pb-20 transition md:col-span-7 lg:col-span-5">
         <div className="sticky top-0 z-50 flex items-center justify-between transition border-b border-x border-gray-200 py-6 backdrop-blur-md dark:border-gray-700">
            {!!session ? (
