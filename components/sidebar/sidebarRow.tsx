...
export default function SidebarRow({ Icon, title, active }: Props) {
   return (
      <div
         className={`flex w-full cursor-pointer items-center space-x-2 rounded-full px-4 py-2 transition-all  duration-300 hover:bg-gray-100 hover:text-twitter dark:hover:bg-gray-300 ${
            active
